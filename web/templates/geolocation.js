...
export async function geolocation(page, route) {
  route.register(
    ...
    async (
      ...
      if (!geo) {
        container.innerHTML =
          '<p style="padding:1rem">NXUI.Geolocation tidakb tersedia — pastikan Nexa.js dimuat.</p>';
        return;
      }
      ...
      <div style="padding: 2rem; font-family: system-ui, sans-serif; max-width: 720px;">
        ...
        <p style="font-size:12px;color:#888">Perlu konteks aman (HTTPS) pada banyak browser.</p>
