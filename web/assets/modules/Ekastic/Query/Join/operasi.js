...
export async function Konfigurasi(data) {
  return {
    title: "Konfigurasi Join Operation",
    col: "nx-col-4",
    footer: `        
     <small>
       <strong>💡 Tips:</strong> Join Operation memungkinkan menggabungkan data dari beberapa tabel.<br>
       <strong>🔄 Update:</strong> Klik "Update Bucket" untuk menerapkan semua konfigurasi join.
     </small>`,
    html: `
        ...
        <div class="nx-step-guide">
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>1.Pilih Type Join</strong>
              <p class="mb-1">Aktifkan "Type Nested" untuk join bersarang atau "Type Cross" untuk join silang.</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>2.Konfigurasi Join Tabel</strong>
              <p class="mb-1">Klik tombol "Join Tabel" untuk menambahkan tabel yang akan di-join dengan tabel utama.</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>3.Set Alias Field</strong>
              <p class="mb-1">Klik tombol "Alias" untuk mengatasi field duplikat dengan memberikan alias unik.</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>4.Konfigurasi Aggregate</strong>
              <p class="mb-1">Klik tombol "Aggregatec" untuk menambahkan fungsi agregasi pada field gabungan.</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>5.Set Arithmetic</strong>
              <p class="mb-1">Klik tombol "Arithmetic" untuk operasi matematika pada field dari berbagai tabel.</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>6.Konfigurasi Where</strong>
              <p class="mb-1">Klik tombol "Where" untuk menambahkan kondisi filter pada hasil join.</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>7.Set Group By</strong>
              <p class="mb-1">Klik tombol "Group" untuk mengelompokkan data hasil join.</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>8.Konfigurasi Order By</strong>
              <p class="mb-1">Klik tombol "Order" untuk mengurutkan hasil join (ASC/DESC).</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>9.Set Foreign Key</strong>
              <p class="mb-1">Klik tombol "Foreign" untuk mengatur relasi foreign key antar tabel.</p>
            </div>
          </div>
          
          <div class="nx-step mb-1">
            <div class="nx-step-content">
              <strong>10.Update Bucket</strong>
              <p class="mb-1">Klik "Update Bucket" untuk menerapkan semua konfigurasi join dan generate query SQL.</p>
            </div>
          </div>
        </div>
      </div>
