...
export const NexaDBLite = {
  ...
  _getDatabase: async function () {
    try {
      ...
      if (currentIsWeb) {
        throw new Error("NexaDBLite tidak tersedia di web platform. Gunakan NexaDBJson atau IndexDB untuk web. SQLite memerlukan WebAssembly yang tidak didukung di web.");
      }
      ...
      // Jika database null, throw error yang jelas
      if (!db) {
