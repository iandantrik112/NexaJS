...
export async function opComplex(data) {
  ...
  setTimeout(async () => {
      ...
      const editorConfig = {
        ...
        onSave:async function(Code) {  
          const finalStorage = saveOprasi(Code, storage, 'operasi');
      ...
      const editor = new NXUI.NexaCmirror('codeEditorcomplex', editorConfig);
 ...
 <div class="nx-card NexaCmirror-editorContainer" style="opacity: 0; visibility: hidden;">
  ...
  <div>
<textarea id="codeEditorcomplex">${addQue}</textarea>
  </div>
  </div>
  <div class="nx-card-footer">
    <div class="nx-alert nx-alert-primary">
      <h5 class="bold mb-2"><span class="material-symbols-outlined">code</span> Complex - SQL Editor</h5>
      <div class="mb-2">
