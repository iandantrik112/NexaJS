 ...
 import { setJoinIN } from "./IN.js";
 import { metaIndex, metaField } from "../../Metadata/Field.js";

export async function setWhereBy(id, tabel) {
  try {
    ...
    NXUI.modalHTML({
      ...
      onclick: {
        title: "Save Where",
        cancel: "Cancel",
        send: "saveWhereValue", // ✅ Use namespaced function name
      },
    ...
    NXUI.id("operator").on("change", function (e) {
      if (e.target.value === "NOT_IN" || e.target.value === "IN") {
        ...
        setJoinIN(value, id, e.target.value, dataform, modalID);
...
nx.saveWhereValue = async function (id, data, tabel) {
  await SaveJoin(id, data, tabel);
};